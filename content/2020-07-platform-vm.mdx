...
With Snow consensus proven and tested, we now reveal the architectural foundation that enables Lux Network's multi-chain vision: the **Platform VM**.
...
The Platform VM inherits Snow consensus security. Additionally:
