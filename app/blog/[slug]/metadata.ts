...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      ...
      authors: [
        {
          name: typeof page.data.author === 'string' ? page.data.author : "Hanzo AI",
          url: siteConfig.url,
        },
      ],
      creator: typeof page.data.author === 'string' ? page.data.author : "Hanzo AI",
      publisher: "Hanzo AI",
      robots: {
        index: true,
        follow: true,
      ...
      openGraph: {
        ...
        authors: [typeof page.data.author === 'string' ? page.data.author : "Hanzo AI"],
